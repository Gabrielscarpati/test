...
class FirebaseInterfaceVerifyIdentity<D extends DataModel, DB extends DataModelBuilder<D>> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  final String tableName;
  final DB dataModelBuilder;

  FirebaseInterfaceVerifyIdentity({required this.tableName, required this.dataModelBuilder});
