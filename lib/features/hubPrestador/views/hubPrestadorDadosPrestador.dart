...
class HubPrestadorDadosPrestador extends StatelessWidget {
  ...
  String getplanoPrestador(int tipoDeplano) {
    ...
    if (tipoDeplano == 3)
      return 'Voce nao esta aparecendo para os usuarios,\n contrate um dos plano o mais rapido\npossivel para conseguir servicos';
    return 'sssd';
  }

  String getListaDecidades(List listaDeCidades) {
    if (listaDeCidades.length == 0)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 1)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 2)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 3)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 4)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 5)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 6)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 7)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 8)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 9)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 10)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 11)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 0)
      return 'Voce nao ainda nao adicionou nenhuma cidade';
    if (listaDeCidades.length == 0)
