...
class BlocInfoDadosPrestador extends Bloc<ViewModelInfoDadosPrestador, BlocEventInfoDadosPrestador> {
  @override
  void onReceiveBlocEvent(BlocEventInfoDadosPrestador blocEvent) {
    if (blocEvent is BlocEventInfoDadosPrestadorInicializaViewModel) _inicializaViewModel(blocEvent);
    if (blocEvent is BlocEventInfoDadosPrestadorAtualizaViewModel) _atualizaViewModel(blocEvent);
  }

  void _inicializaViewModel(BlocEventInfoDadosPrestadorInicializaViewModel blocEvent) async {
  ...
  void _atualizaViewModel(BlocEventInfoDadosPrestadorAtualizaViewModel blocEvent) {
    ViewModelInfoDadosPrestador viewModel = ViewModelInfoDadosPrestador(
        cidades: blocEvent.viewModel.cidades,
        prestador: blocEvent.viewModel.prestador,
    ...
    BusinessModelDadosPrestador businessModel = BusinessModelDadosPrestador(
      ...
      numeroDeCliquesNoLigarOuWhatsApp: viewModel.prestador.numeroDeCliquesNoLigarOuWhatsApp ,
