                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: _renderizarAvatar(
                                context, viewModel, viewActions),
                          ),
                        ],
                      ),
                      Row(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: IconButton(
                  onPressed: () {
                    viewActions.abrirInterfaceGaleriaCamera(
                        ImageSource.camera, viewModel, viewModel.usuario);
                  },
              ...
              Container(
                ...
                child: IconButton(
                  onPressed: () {
                    viewActions.abrirInterfaceGaleriaCamera(
                        ImageSource.gallery, viewModel, viewModel.usuario);
                  },
                  color: Colors.white70,
