...
class StatementModel {
  ...
  String getMoment() {
    return DateFormat("MMMM d", 'pt_BR')
        .format(DateTime.parse(moment!).toLocal());
  }
  ...
  getMessage() {
    ...
    String day =
        DateFormat("d", 'pt_BR').format(DateTime.parse(moment!).toUtc());
    String month =
        DateFormat("MMMM", 'pt_BR').format(DateTime.parse(moment!).toUtc());
    String hour =
        DateFormat("HH", 'pt_BR').format(DateTime.parse(moment!).toUtc());
    String min =
        DateFormat("mm", 'pt_BR').format(DateTime.parse(moment!).toUtc());
