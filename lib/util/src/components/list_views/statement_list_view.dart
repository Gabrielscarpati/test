...
class StatementList extends StatelessWidget {
  const StatementList({Key? key, required this.statements}) : super(key: key);
              ...
              ListTile(
                onTap: () {
                  Alert.displaySimpleAlert(
                      '${statement.getTitle()}', '${statement.getMessage()}');
                },
                title: Text('${statement.getTitle()}',
                    style: TextStyle(fontSize: 18)),
                subtitle: Text('${statement.getSubtitle()}',
