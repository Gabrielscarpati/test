...
import 'package:projeto_treinamento/util/src/views/home_subpages/initial_screen_subpages/pix_details_screen.dart';

import '../../../components/drawer/drawer.dart';
import '../../../components/headers/header.dart';
import '../../../components/loaders/index.dart';
...
class _PixScreenState extends State<PixScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(icon: Icon(Icons.refresh_outlined), onPressed: refresh)
        ],
      ),
      drawer: MyDrawer(),
      body: Stack(children: [
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => PixDetails(
                          type: PixDetailsType.NEW,
                          pix: PixResponse(id: 0, pixKeys: "teste"),
                        )));
          },
