...
import '../../utils/creator_util.dart';
import '../../utils/string_util.dart';

class TransferScreen extends StatefulWidget {
  const TransferScreen({Key? key, required this.balance}) : super(key: key);
...
class _TransferScreenState extends State<TransferScreen> {
  ...
  late TransferController _transferController;

  @override
  void initState() {
    super.initState();
    _transferController = TransferController(
        _moneyMaskedController, _receiverController, widget.balance);
